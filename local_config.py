...
ERPNEXT_API_KEY = 'a7ea61cea04e3e1'
ERPNEXT_API_SECRET = '4f3a3bf2f67f18f'
...
devices = [
    {'device_id':'Machine_1','ip':'192.168.10.121', 'punch_direction':'AUTO', 'clear_from_device_on_fetch': False},
    {'device_id':'Machine_2','ip':'192.168.2.209', 'punch_direction': None, 'clear_from_device_on_fetch': False}
]
